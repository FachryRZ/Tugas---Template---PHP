                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT teachers.id AS idt, teachers.nip, teachers.name, teachers.pob, teachers.dob, teachers.phone, subjects.subject FROM teachers JOIN subjects ON subjects.id=teachers.subject_id ORDER BY name ASC";
